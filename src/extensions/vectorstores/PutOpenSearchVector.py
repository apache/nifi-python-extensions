...
from EmbeddingUtils import EMBEDDING_MODEL, create_embedding_service, OPENAI_API_MODEL, HUGGING_FACE_MODEL
...
@use_case(
    description="Create vectors/embeddings that represent text content and send the vectors to OpenSearch",
...
class PutOpenSearchVector(FlowFileTransform):
    ...
    def transform(self, context, flowfile):
        ...
        vectorstore = OpenSearchVectorSearch(
            opensearch_url=http_host, index_name=index_name, embedding_function=self.embeddings, **params
        )
